...
echo "4. Include project_id when using Token Authentication\n";
echo "5. Deletion is permanent - there is no undo\n";
echo "6. Handle errors appropriately (404 = not found, 403 = access denied)\n";
echo "7. The method returns void on success (204 No Content)\n";
